...
const InvoicingIcon: React.FC<Props> = ({ active }) => {
  return (
    <svg
      width="24"
      height="24"
    ...
    >
      ...
      <path
        ...
        fill={
          active ? "url(#paint0_linear_16719_1194)" : "rgba(136, 143, 149, 0.6)"
        }
      />
      ...
      <path
        ...
        fill={
          active ? "url(#paint1_linear_16719_1194)" : "rgba(136, 143, 149, 0.6)"
        }
      />
      ...
      <path
        ...
        fill={
          active ? "url(#paint2_linear_16719_1194)" : "rgba(136, 143, 149, 0.6)"
        }
      />

      <defs>
        <linearGradient
          id="paint0_linear_16719_1194"
          x1="8.2422"
          y1="13.8522"
          x2="20.5182"
          y2="13.8522"
