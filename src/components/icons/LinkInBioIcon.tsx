...
export default function LinkInBioIcon({ active }: Props) {
  return (
    <svg
      width="24"
      height="24"
    ...
    >
      <path
        ...
        stroke={active ? "url(#paint0_linear_16719_1177)" : "#888F95"}
        strokeWidth="2.7"
        strokeMiterlimit="10"
      />
      <path
        ...
        stroke={active ? "url(#paint1_linear_16719_1177)" : "#888F95"}
        strokeWidth="2.7"
        strokeMiterlimit="10"
      />
      <path
        ...
        fill={active ? "url(#paint2_linear_16719_1177)" : "#888F95"}
      />
      <defs>
        <linearGradient
          id="paint0_linear_16719_1177"
          x1="2.89818"
          y1="8.44539"
          x2="18.1055"
          y2="8.44539"
