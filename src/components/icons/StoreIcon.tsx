...
export default function StoreIcon({ active }: Props) {
  return (
    <svg
      width="20"
      height="22"
    ...
    >
      <path
        ...
        fill={active ? "url(#paint0_linear)" : "#888F95"}
      />
      <path
        ...
        fill={active ? "url(#paint1_linear)" : "#888F95"}
      />
      <path
        ...
        fill={active ? "url(#paint2_linear)" : "#888F95"}
      />
      <defs>
        <linearGradient
          id="paint0_linear"
